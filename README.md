...
ブックマークにメモを残すことで、後からの検索を容易にでき、辞書のように使うことが可能です。
会社内や友人同士で共有することで、WEBサイトの効率的な利用をすることができます。
...
### Contents Page
ブックマークには、タイトル・説明（メモ）・グループ区分を自由に登録します。
登録サイトは、アプリのフレーム内での閲覧もできます。
ユーザー同士でコメントを投稿することで情報の共有ができます。
